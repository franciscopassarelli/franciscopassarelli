...
- 👨🏽‍💻 Estudiante certificado en **Coderhouse. Carrera de Desarrollo Front-End React JS / (especializandome con Next.js). Cuento con herramientas de Testing QA Manual.(Postman API, SQL).**
